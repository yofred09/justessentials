...
public final class EssentialsPermissions {
    ...
    public static void register(PermissionGatherEvent.Nodes event) { event.addNodes(STAFF_CHAT, SILENT_TP, HISTORY, KICK, BAN, HEAL, FEED, FLY, GOD, SPAWN, BACK, INVSEE, ENDERSEE, CURIOSSEE, MUTE, FREEZE, STAFF_MODE, DISCORD_TEST); }
